...
class Communicator(Node):
    ...
    def __init__(self):
        ...
        self.vel_publisher = self.create_publisher(Twist, '/diffbot_base_controller/cmd_vel_unstamped', 10)
...
def main():
    ...
    initial_pose.pose.position.x = -0.026  
    initial_pose.pose.position.y = -0.048  
    ...
    loading_position.pose.position.x = 5.7
    loading_position.pose.position.y = -0.36  
    loading_position.pose.orientation.z = -0.707  
    loading_position.pose.orientation.w = 0.707  
    ...
    Shipping_position.pose.position.x = 2.5
    Shipping_position.pose.position.y = 1.3  
    ...
    #return_pose.header.stamp = navigator.get_clock().now().to_msg()
